...
async function seedList(client: PoolClient): Promise<void> {
  ...
  await client.query(
    `
      INSERT INTO list_items(id, list_id, name, icon_name, quantity_or_unit, category, created_by_device_id)
      VALUES
        ($1, $2, 'Milk', 'milk', '1', 'dairy', $3),
        ($4, $2, 'Eggs', 'egg', '12', 'dairy', $3),
        ($5, $2, 'Bread', 'bread', '1', 'bakery', $3)
      ON CONFLICT (id) DO NOTHING
    `,
