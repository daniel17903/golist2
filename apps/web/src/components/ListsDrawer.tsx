        ...
        >
          ...
          <div className="drawer__section">
            ...
            <div className="drawer__list">
              {lists.map((list) => {
                const meta = listMetaById[list.id] ?? { openItemsCount: 0, lastUpdatedAt: list.updatedAt };
                  ...
                  <div key={list.id} className="drawer__item">
                    ...
                    >
                      ...
                      <span className="drawer__item-content">
                        ...
                        <span className="drawer__item-meta">{meta.openItemsCount} offen · {formatUpdatedAt(meta.lastUpdatedAt)}</span>
                      </span>
                    </button>
                    <button
                      type="button"
                      className={`drawer__delete ${isPendingDelete ? "drawer__delete--confirm" : ""}`}
                      aria-label={isPendingDelete ? `${list.name} endgültig löschen` : `${list.name} löschen`}
                      onClick={() => {
                        if (!isPendingDelete) {
