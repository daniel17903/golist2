  ...
  return (
    <div className="app">
        ...
        onShareList={() => {
          void (async () => {
            try {
              ...
              pushToast("Teilen-Link wurde in die Zwischenablage kopiert.");
            } catch {
              pushToast("Teilen ist derzeit nicht verfügbar.");
            }
          })();
        }}
      />
      ...
      <ListsDrawer
        ...
        openItemCountByListId={listOpenItemCountById}
