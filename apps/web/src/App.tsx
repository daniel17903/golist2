...
const App = () => {
  ...
  const showAppToast = (message: string, variant: AppToast["variant"]) => {
    const toastId = crypto.randomUUID();
    setAppToasts((current) => [...current, { id: toastId, message, variant }]);
  ...
  return (
    <div className="app">
      <AppHeader
        ...
        hasActiveBackendRequests={hasActiveBackendRequests}
      />
