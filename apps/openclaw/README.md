...
The skill is intentionally single-list scoped, uses the fixed API base URL `https://go-list.app/api`, generates/persists its own device UUID, and avoids icon/category mapping by default.
...
python3 apps/openclaw/golist_cli.py upsert "milk"
```
